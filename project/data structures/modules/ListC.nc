...
//To make CachList command in FloodingP.nc easier to implement,
//I made added a command or "function" to return maximun size of list(at the bottom) 
...
implementation{
	...
	//to return max size of list
	command uint16_t List.sizeMax(){
		return MAX_SIZE;
	}
}
